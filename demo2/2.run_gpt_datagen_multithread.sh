...
# python ../OpenAIGPT_datagen_multithread.py --keys_path ../gpt3keys.txt --input_path ./data/2.rlhf_prepared.jsonl  --output_path ./data/3.rlhf_aftgpt.jsonl --max_workers 50